...
def generate_sources(dir_files_tuples):
    ...
    for dir, files in dir_files_tuples:
        full_files = [os.path.join(dir, file) for file in files]
...
long_description = (
    "CrossCat is a domain-general, Bayesian method for analyzing "
...
setup(
    ...
    package_dir={
        ...
        "crosscat.tests.component_model_extensions": "src/tests/component_model_extensions",
